...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Painel Financeiro — 99Food & Moto" },
      { name: "description", content: "Acompanhe seus saques 99Food e gastos da moto em um só lugar." },
      { property: "og:title", content: "Painel Financeiro — 99Food & Moto" },
      { property: "og:description", content: "Acompanhe seus saques 99Food e gastos da moto em um só lugar." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Painel Financeiro — 99Food & Moto" },
      { name: "twitter:description", content: "Acompanhe seus saques 99Food e gastos da moto em um só lugar." },
